      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="max-w-md mx-auto">
          <Card className="shadow-xl border-0 bg-white/95 backdrop-blur-sm">
            ...
            <span className="font-bold text-2xl">LaunchStack</span>
          </Link>
        </div>
        ...
        <Card className="shadow-xl border-0 bg-white/80 backdrop-blur-sm">
          <CardHeader className="space-y-1 pb-6">
            <CardTitle className="text-2xl font-bold text-center">
              {emailVerification ? 'Verify your email' : (isSignUp ? 'Create your account' : 'Welcome back')}
            </CardTitle>
            <CardDescription className="text-center text-gray-600">
              {emailVerification 
                ? 'Enter the verification code sent to your email'
                : (isSignUp 
                  ? 'Join thousands of users automating with LaunchStack' 
                  : 'Sign in to your LaunchStack account'
                )
              }
            </CardDescription>
