...
export function AuthForm({ type }: AuthFormProps) {
  ...
  const handleSocialAuth = async (provider: 'oauth_google' | 'oauth_github' | 'oauth_apple') => {
    try {
      if (isSignUp) {
            ...
            <CardHeader className="space-y-1 pb-6">
              ...
              <CardDescription className="text-center text-gray-600">
                {emailVerification 
                  ...
                  : isSignUp 
                    ? 'Start your n8n hosting journey with LaunchStack'
                    : 'Sign in to your LaunchStack account'
                }
              </CardDescription>
            </CardHeader>
            ...
            <CardContent className="space-y-6">
              {emailVerification ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <Button
                    type="submit"
                    className="w-full h-12 bg-black hover:bg-gray-800 text-white font-semibold text-base transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
                    disabled={loading}
                  >
                ...
                <>
                  ...
                  <div className="space-y-3">
                    ...
                    >
                      <svg className="w-5 h-5 mr-3" fill="currentColor" viewBox="0 0 24 24">
                        <path d="M18.71 19.5c-.83 1.24-1.71 2.45-3.05 2.47-1.34.03-1.77-.79-3.29-.79-1.53 0-2 .77-3.27.82-1.31.05-2.3-1.32-3.14-2.53C4.25 17 2.94 12.45 4.7 9.39c.87-1.52 2.43-2.48 4.12-2.51 1.28-.02 2.5.87 3.29.87.78 0 2.26-1.07 3.81-.91.65.03 2.47.26 3.64 1.98-.09.06-2.17 1.28-2.15 3.81.03 3.02 2.65 4.03 2.68 4.04-.03.07-.42 1.44-1.38 2.83M13 3.5c.73-.83 1.94-1.46 2.94-1.5.13 1.02-.3 2.05-.84 2.78-.54.73-1.5 1.37-2.47 1.25-.15-.96.32-1.96.37-2.53z"/>
                      </svg>
                      Continue with Apple
                    </Button>
                  </div>
