...
import { useApiClient, type Instance } from '@/lib/api-client';
...
export function EditInstanceDialog({ children, instance, onInstanceUpdated }: EditInstanceDialogProps) {
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Update the name and description of your n8n instance.
          </DialogDescription>
        </DialogHeader>
