                ...
                <>
                  ...
                  <div className="space-y-2">
                    <Button
                      type="button"
                      variant="outline"
                      className="w-full h-10 border-gray-200 hover:border-gray-300 hover:bg-gray-50 transition-all duration-300 text-sm"
                    ...
                    <div className="space-y-1">
                      ...
                      <div className="relative">
                        ...
                        <Input
                          ...
                          className="pl-10 pr-10 h-10 border-gray-200 focus:border-black focus:ring-black text-sm"
                          required
                        />
                        <button
                          type="button"
